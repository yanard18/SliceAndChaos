...
namespace DenizYanar
{
    public class PlayerMagnetController : MonoBehaviour
    {
        ...
        {
            _inputs.e_OnMagnetPullStarted += OnMagnetPullInputStarted;
            _inputs.e_OnMagnetPullCancelled += OnMagnetPullInputReleased;
            _inputs.e_OnMagnetPushPressed += OnMagnetPushInputPressed;
        }
